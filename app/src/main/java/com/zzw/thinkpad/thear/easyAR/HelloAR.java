        ...
        try {
            ...
            for (TargetInstance targetInstance : frame.targetInstances()) {
                ...
                if (status == TargetStatus.Tracked) {
                    ...
                    if (hasListened == false) {
                        mTrackedListener.trackedSuccess(imagetarget.name());
                        isSussess = true;
                    }
...
//                    }
            ...
            if (isSussess != true) {
                mTrackedListener.trackedFailed();
            }
    ...
    public void setTrackedListener(TrackedListener trackedListener) {
        mTrackedListener = trackedListener;
    }

    TrackedListener mTrackedListener;

    public interface TrackedListener {
        void trackedSuccess(String targetName);
