...
import com.zzw.thinkpad.thear.ui.activity.mygarden.View.ManageActivity;
    ...
    public void handViewClick(View view) {
        ...
        if (tag instanceof Water) {
          ...
          //  Toast.makeText(getContext(), "当前点击的是：" + waterTag.getName() + "水滴的值是:"
            ManageActivity manageActivity =(ManageActivity)BaseAppManager.getInstance().getForwardActivity();
            num=num+waterTag.getNumber();
           // ToastUtil.showLongToast(getContext(), String.valueOf(num));
